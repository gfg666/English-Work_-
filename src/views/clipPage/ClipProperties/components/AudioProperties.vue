    ...
    <div class="mb-6">
        ...
        <div class="flex gap-3 mb-3">
            <div class="flex-1">
                ...
                <el-input-number class="w-30" v-model="clip.sourceStartTime" size="small" :min="0" :step="0.1"
                    placeholder="去片头时间" @change="val => handleDefaultZero(val, 'sourceStartTime')" />
            </div>
            <div class="flex-1">
        ...
        <div class="flex items-center gap-3">
            <div class="flex-1">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <Icon v-if="clip.volume === 100" icon="material-symbols:volume-up" @click="clip.volume = 0" />
                    <Icon v-else-if="clip.volume !== 0" icon="material-symbols:volume-down" @click="clip.volume = 0" />
